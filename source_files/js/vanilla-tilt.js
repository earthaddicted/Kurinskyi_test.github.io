...
var VanillaTilt = function () {
  ...
  var VanillaTilt = function () {
    ...
    _createClass(VanillaTilt, [{
      ...
      key: "init",
      value: function init(elements, isNeeded, settings) {
  ...
  function checkIfVanillaIsNeeded() {
    var w = window.innerWidth;
    if (w > 1024) {
      VanillaTilt.init(document.querySelectorAll("[data-tilt]"), true);
    } else {
      VanillaTilt.init(document.querySelectorAll("[data-tilt]"), false);
    }
  }
  ...
  if (typeof document !== "undefined") {
     ...
     * Auto load
     */
    checkIfVanillaIsNeeded();
    window.addEventListener('resize', checkIfVanillaIsNeeded);
  }
